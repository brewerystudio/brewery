...
export class Info extends Page<InfoProps> {
    ...
    public renderMobile = () => {
        ...
        return (
            <div className={'wrapper h-75 d-flex flex-column justify-content-center mt-4'}>
                ...
                <div className={'info-thumbnail-mobile-container normal-scroll'}>
                    {
                        page === 'services' &&
                    ...
                    {
                        page === 'floorplan' &&
                        <div className={'info-page-mobile pl-4 pr-4'}>
                            <FlipCard flipOnClick={'both'} className={'info-thumbnail-mobile color-white btn-box animated w-100 h-100 d-flex flex-column justify-content-center align-items-center'}
                                childrenFront={
                                    <div className={'w-100 h-100 d-flex flex-column justify-content-center align-items-center'}>
                                        <div className={'h7 upper mt-3'}>FLOOR PLAN</div>
                                        <div className={'font-title h4 upper m-0 mb-3'}>NEW YORK</div>
                        ...
                        <div className={'info-page-mobile pl-4 pr-4'}>
                            <FlipCard flipOnClick={'both'} className={'info-thumbnail-mobile color-white btn-box animated w-100 h-100 d-flex flex-column justify-content-center align-items-center'}
                                childrenFront={
                                    ...
                                    <div className={'h7 upper mt-3'}>BREWERY RECORDING STUDIO</div>
                                    <div className={'font-title h4 upper m-0 mb-4'}>HISTORY</div>
                                        <Image src="assets/history/team.jpg" alt="Team" className={'w-80'} />
    ...
    private configureDragScrolling = () => {
        ...
        $("#services-mobile").mouseup((e) => {
            ...
            $("#services-mobile").mousemove((e2: any) => {
                const newY = top - e2.pageY + y
                const newX = left - e2.pageX + x
                console.log('newX', newX, 'newY', newY)
                e2.preventDefault()
                $("#services-mobile").scrollTop(newY)
                $("#services-mobile").scrollLeft(newX)
            })
        })
        $("#gear-mobile").mouseup((e) => {
            ...
            // Create mouse move events to enable drag scrolling
            $("#gear-mobile").mousemove((e2: any) => {
                e2.preventDefault()
                $("#gear-mobile").scrollTop(top - e2.pageY + y)
                $("#gear-mobile").scrollLeft(left - e2.pageX + x)
            })
        })
        $("#services-mobile").mouseup((e) => {
