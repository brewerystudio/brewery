...
export class EngineerSlide extends Component {

    public render = () => {
        const engineer:Engineer = (this.props as any).engineer
        const studio:Studio = (this.props as any).studio
        ...
        return (
            <div className={'position-relative d-flex flex-column justify-content-end p-0 m-0 h-100'}>
                    ...
                    <div className={'d-flex flex-row mt-4 mb-2 w-100'}>
                        <div className={'pl-2 pr-2'}>
                            <Button
                                ...
                                onClick={() => onChangeStudio(Studio.NewYork)}
                                fontSize={'1rem'}
                                text={'NEW YORK'}
                            />
                        </div>
                        <div className={'pl-2 pr-2 studio-name-border-left'}>
                            <Button
                                ...
                                onClick={() => onChangeStudio(Studio.LosAngeles)}
                                fontSize={'1rem'}
                                text={'LOS ANGELES'}
                            />
                        </div>
                ...
                <img className={'engineer-slide-image p-0 m-0'} src={engineer.photoURL} alt={engineer.name} />
            </div>
        )
    }
    ...
    static propTypes = {
        ...
        studio: t.any.isRequired,
        onChangeStudio: t.any.isRequired,
    }
