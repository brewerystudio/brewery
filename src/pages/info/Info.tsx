...
export class Info extends Page {
                ...
                }
                {
                    ...
                    <div className={'info-page pl-4 pr-4'}>
                        <div className={'row pt-2'}>
                            ...
                            >
                                <FlipCard ref={r => this.nyGearFlipCard = r!} flipOnClick={'back'} className={'w-100 h-100 info-thumbnail-long color-white btn-box p-0'}
                                    childrenFront={
                                        <div className={'w-100 h-100 d-flex flex-column justify-content-center align-items-center'}>
                                ...
                                <FlipCard ref={r => this.nyGearFlipCard = r!} flipOnClick={'both'} className={'w-100 info-thumbnail-wide color-white btn-box'}
                                    childrenFront={
                                        <div className={'w-100 h-100 d-flex flex-column justify-content-center align-items-center'}>
                                            ...
                                            <img src="assets/floorplans/ny.png" className={'w-100'} />
                                    ...
                                    childrenBack={
                                        <div className={'w-100 h-100 d-flex flex-column justify-content-center align-items-center'}>
                                            ...
                                            <img src="assets/floorplans/la.png" className={'w-100'} />
                                ...
                                <FlipCard ref={r => this.nyGearFlipCard = r!} flipOnClick={'both'} className={'w-100 info-thumbnail-wide color-white btn-box'}
                                    childrenFront={
                                        ...
                                        <div className={'font-title h4 upper m-0 mb-4'}>HISTORY</div>
                                            <img src="assets/history/team.jpg" className={'w-50'} />
    ...
    public renderMobile = () => {
        ...
        return (
            <div className={'wrapper h-75 d-flex flex-column justify-content-center mt-4 mb-4'}>
                <div className={'pl-4 pr-4 mb-3'}>
                    <div className={'row m-0 pl-4 pr-4 pb-2'}>
                        <div className={'col-6 pl-1 pr-1'}>
                            <button onClick={() => this.setPage('services')} className={`color-white btn-box animated w-100 font-tertiary ${active('services')}`}>SERVICES</button>
                        </div>
                        <div className={'col-6 pl-1 pr-1'}>
    ...
    private getMobileHeight = () => $('.info-thumbnail-mobile').get().length > 0 ? $('.info-thumbnail-mobile').get()[0].clientWidth * 1.4 : 0
    ...
    private getWideHeight = () => $('.info-thumbnail-wide').get().length > 0 ? $('.info-thumbnail-wide').get()[0].clientWidth * 0.6 : 0
